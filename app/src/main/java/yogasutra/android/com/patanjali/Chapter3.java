...
public class Chapter3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chap3_main);

        Toast toast = Toast.makeText(this,"VIBHUTI PAADA",Toast.LENGTH_SHORT);
        toast.show();
        ...
        mediaPlayer = MediaPlayer.create(Chapter3.this, R.raw.vibuthi_paada);
        ...
        ply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                runOnUiThread(run);
                Toast toast = Toast.makeText(Chapter3.this,"Playing",Toast.LENGTH_SHORT);
                toast.show();
        ...
        pse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer.isPlaying())
                    mediaPlayer.pause();
                Toast toast = Toast.makeText(Chapter3.this,"Paused",Toast.LENGTH_SHORT);
                toast.show();
        ...
        try {
            ...
            Log.d("MAIL","prob in mail in chapter3");
    ...
    void ReadShloka() {
        InputStream IS = getApplicationContext().getResources().openRawResource(R.raw.chapter3);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_intro) {
            ...
            Intent intent = new Intent(Chapter3.this,Introduction.class);
            ...
            Intent intent = new Intent(Chapter3.this,Chapter1.class);
            startActivity(intent);
